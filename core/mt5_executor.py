...
class MT5Executor:
    def __init__(self, settings: Settings, label: str = "Account 1", terminal_path: str = ""):
        self.settings       = settings
        self.label          = label
        self.terminal_path  = terminal_path   # path to terminal64.exe, empty = auto-detect
    ...
    def connect(self) -> bool:
        ...
        if self.terminal_path:
            ...
            logger.info(f"[{self.label}] Using terminal: {self.terminal_path}")
